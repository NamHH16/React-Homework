...
export default class Home extends Component {
  ...
  deleteCart = (id) => {
    ...
    const index = newCart.findIndex((cart) => {
  ...
  increaseCart = (id) => {
    ...
    if (newCart[index].quantity > newCart[index].product.quantity) {
      newCart[index].quantity = newCart[index].product.quantity;
    }
    ...
    return (
      <div className="container">
        ...
        {this.state.selectedProduct && (
          <ProductsDetails selectedProduct={this.state.selectedProduct} />
        )}
        <Cart
